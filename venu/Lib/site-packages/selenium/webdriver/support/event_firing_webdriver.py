...
class EventFiringWebDriver(object):
    ...
    起步代码里不用ID 而是使用XID替代
    '''
    def find_element_by_xid(self, xid_):
        return self.find_element(by=By.XID, value=xid_)

    def find_elements_by_xid(self, id_):
        return self.find_elements(by=By.XID, value=xid_)
