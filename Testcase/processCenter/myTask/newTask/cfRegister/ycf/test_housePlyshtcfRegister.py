...
class Test_houseYshtcfRegister():
    ...
    def test_houseYshtcfRegister(self,login,cmdopt):
        ...
        logger.debug("<--------查封登记---预查封---批量预售合同查封start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------查封登记---预查封---批量预售合同查封end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_houseYshtcfRegister'])
