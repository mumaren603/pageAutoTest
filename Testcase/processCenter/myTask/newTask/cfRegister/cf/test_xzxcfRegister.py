...
class Test_xzxcfRegister():
    ...
    def test_xzxcfRegister(self,login,cmdopt):
        ...
        logger.debug("<--------查封登记--查封--土地小证续查封start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------查封登记--查封--土地小证续查封end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_xzxcfRegister'])
