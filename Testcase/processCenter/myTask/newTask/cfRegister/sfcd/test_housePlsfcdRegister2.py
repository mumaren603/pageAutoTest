...
class Test_housePlsfcdRegister2():
    ...
    def test_housePlsfcdRegister2(self,login,cmdopt):
        ...
        logger.debug("<--------查封登记-->司法裁定批量（房地）start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------查封登记-->司法裁定批量（房地）end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_housePlsfcdRegister2'])
