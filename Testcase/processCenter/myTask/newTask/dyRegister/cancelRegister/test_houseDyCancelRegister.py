...
class Test_houseDyCancelRegister():
    ...
    def test_houseDyCancelRegister(self,login,cmdopt):
        ...
        logger.debug("<--------抵押权--注销登记--不动产抵押注销start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------抵押权--注销登记--不动产抵押注销end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_houseDyCancelRegister'])
