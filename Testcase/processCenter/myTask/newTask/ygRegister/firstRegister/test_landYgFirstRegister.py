...
class Test_landYgFirstRegister():
    ...
    def test_landYgFirstRegister(self,login,cmdopt):
        ...
        logger.debug("<--------预告登记--首次登记--净地预告start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------预告登记--首次登记--净地预告end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_landYgFirstRegister'])
