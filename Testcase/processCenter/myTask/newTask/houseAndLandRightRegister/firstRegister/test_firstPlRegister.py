...
class Test_firstPlRegister():
    ...
    def test_firstPlRegister(self,login,cmdopt):
        ...
        logger.debug("<--------国有建设用地使用权及房屋所有权--首次登记--首次批量start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------国有建设用地使用权及房屋所有权--首次登记--首次批量end-------->")
