...
class Test_houseXcfRegister():
    ...
    def test_houseXcfRegister(self,login,cmdopt):
        ...
        logger.debug("<--------查封登记--查封--续查封登记（房屋）start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------查封登记--查封--续查封登记（房屋）end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_houseXcfRegister'])
