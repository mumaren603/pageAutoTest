...
class Test_landXcfRegister():
    ...
    def test_landXcfRegister(self,login,cmdopt):
        ...
        logger.debug("<--------查封登记--查封--续查封登记（净地）start-------->")
        ...
        try:
            ...
            raise
        logger.debug("<--------查封登记--查封--续查封登记（净地）end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v', 'test_landXcfRegister'])
