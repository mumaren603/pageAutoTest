...
class Test_yzxChangeRegister():
    ...
    def test_yzxChangeRegister(self,login,cmdopt):
        ...
        try:
            ...
            raise
        logger.debug("<--------国有建设用地使用权及房屋所有权--首次登记--预告转现end-------->")
...
if __name__ == '__main__':
    pytest.main(['-v','test_yzxChangeRegister'])